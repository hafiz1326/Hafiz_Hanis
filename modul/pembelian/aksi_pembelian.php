...
$id_suplier = $_POST['id_suplier'];
$jumlah = $_POST['jumlah'];
$harga = $_POST['harga']; $total = $_POST['total'];
$keterangan = $_POST['keterangan'];
$query = "UPDATE tbl_pembelian SET invoice='$invoice', tanggal='$tanggal', id_suplier='$id_suplier', jumlah='$jumlah',
...
$exec = mysqli_query($koneksi, $query);
if($exec){
$_SESSION['pesan'] = "Data pembelian telah dihapus"; header('location:../../dashboard.php?modul=pembelian');
}else{
