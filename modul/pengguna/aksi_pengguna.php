...
jabatan, email, hak_akses) values ('$username', '$password', '$nama_lengkap', '$jabatan', '$email', '$hak_akses')";
...
$query = "update tbl_pengguna set password = '$password', nama_lengkap = '$nama_lengkap', jabatan = '$jabatan', email '$hak_akses' where username = '$username'"; = '$email', hak_akses =
}
$exc = mysqli_query($koneksi, $query);
if($exc){
