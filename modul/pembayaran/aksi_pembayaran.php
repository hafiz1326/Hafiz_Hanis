...
if($_GET['act'] == "insert"){
$query = "INSERT INTO tbl_pembayaran (invoice, tanggal, total, keterangan) VALUES ('$invoice', '$tanggal', '$total', '$keterangan')";
...
$id = $_GET['id'];
$query = "UPDATE tbl_pembayaran SET invoice = '$invoice', tanggal = '$tanggal', total = '$total', keterangan = '$keterangan' WHERE id = '$id'";
$exec = mysqli_query($koneksi, $query);
if($exec) {
